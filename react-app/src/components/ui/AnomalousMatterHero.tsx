 ...
 *   - Wireframe mode
 *   - Mouse-driven point-light that chases the cursor
 *
 * Used as the ShaderAnimation section between KnowledgeGraph and Comparison.
 */
  ...
  useEffect(() => {
    ...
    const material = new THREE.ShaderMaterial({
      uniforms: {
        ...
        color:         { value: new THREE.Color(0x38bdf8) }, // sky-300 equivalent
      },
...
export function AnomalousMatterHero({
  ...
  return (
    <section
      id="shader-section"
      role="banner"
      aria-label="Generative art hero section"
      style={{
        position: 'relative',
        width: '100%',
        height: '100vh',
    ...
    >
      ...
      {/* Gradient overlay — bottom-up fade so text is readable */}
      <div
        aria-hidden
        style={{
          position: 'absolute',
      ...
      >
        <div style={{ maxWidth: '48rem', padding: '0 1rem' }} className="anomaly-text-group">
          <h2
            style={{
