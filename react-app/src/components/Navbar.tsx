    ...
    <nav id="navbar" className={`navbar${scrolled ? ' scrolled' : ''}`}>
      <div className="navbar-inner">
        ...
        <div className={`navbar-links${mobileOpen ? ' open' : ''}`} id="nav-links">
          <a href="#features" className="nav-link" id="nav-features" onClick={handleNavClick}>Features</a>
          <a href="#how-it-works" className="nav-link" id="nav-how" onClick={handleNavClick}>How It Works</a>
          <a href="#agents" className="nav-link" id="nav-agents" onClick={handleNavClick}>Agents</a>
          <a href="#scanner" className="nav-link" id="nav-scanner" onClick={handleNavClick}>Scanner</a>
          <a href="#knowledge-graph" className="nav-link" id="nav-graph" onClick={handleNavClick}>Graph</a>
          <a href="#contact" className="nav-link" id="nav-contact" onClick={handleNavClick}>Contact</a>
        </div>

        <div className="navbar-actions">
          <button className="theme-toggle" id="theme-toggle" onClick={onThemeToggle} aria-label="Toggle theme">
